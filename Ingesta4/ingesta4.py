...
tabla_dynamo = f'{stage}-hotel-reservations'  # Ejemplo: dev-hotel-users, test-hotel-users, prod-hotel-users
archivo_csv = f'{stage}-reservations.csv'  # Ejemplo: dev-usuarios.csv, test-usuarios.csv, prod-usuarios.csv
glue_database = f'hotel-{stage}'  # Ejemplo: stage-dev, stage-test, stage-prod
glue_table_name = f'hotel-{stage}-reservations'  # Ejemplo: stage-dev-usuarios, stage-test-usuarios, stage-prod-usuarios
