...
tabla_dynamo = f'{stage}-hotel-services'  # Ejemplo: dev-hotel-users, test-hotel-users, prod-hotel-users
nombre_bucket = f'{stage}-ingesta-hotel'  # Ejemplo: ingesta-hotel-stage-dev, ingesta-hotel-stage-test, ingesta-hotel-stage-prod
archivo_csv = f'{stage}-services.csv'  # Ejemplo: dev-usuarios.csv, test-usuarios.csv, prod-usuarios.csv
glue_database = f'hotel-{stage}'  # Ejemplo: stage-dev, stage-test, stage-prod
glue_table_name = f'hotel-{stage}-services'  # Ejemplo: stage-dev-usuarios, stage-test-usuarios, stage-prod-usuarios
